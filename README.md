...
# IBM Cloud Master Data Management Java SDK Version 1.0.4
...
--- | ---
[Master Data Management](https://cloud.ibm.com/apidocs/mdm) | com.ibm.cloud:mdm:1.0.4 
...
### Gradle
```gradle
compile 'com.ibm.cloud:mdm:1.0.4'
```
