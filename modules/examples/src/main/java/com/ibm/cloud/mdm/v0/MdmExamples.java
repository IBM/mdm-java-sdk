...
public class MdmExamples {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      Response<PublishModelStatus> response = mdmService.publishConfiguratorModel(publishConfiguratorModelOptions).execute();
    ...
    try {
      ...
      Response<MatchingStatus> response = mdmService.initiateConfiguratorMatching(initiateConfiguratorMatchingOptions).execute();
    ...
    try {
      ...
      Response<ProcessStatus> response = mdmService.bulkLoadConfigurator(bulkLoadConfiguratorOptions).execute();
    ...
    try {
      ...
      CreateDataRecordOptions createDataRecordOptions = new CreateDataRecordOptions.Builder()
        .attributes(new java.util.HashMap<String, Object>() { { put("foo", new HashMap<>().put("foo", "bar")); } })
        .build();
    ...
    try {
      ...
      ReplaceDataRecordOptions replaceDataRecordOptions = new ReplaceDataRecordOptions.Builder()
        .id(Long.valueOf("26"))
        .newAttributes(new java.util.HashMap<String, Object>() { { put("foo", new HashMap<>().put("foo", "bar")); } })
        .build();
    ...
    try {
      ...
      Response<AssetDeletionStatus> response = mdmService.deleteConfiguratorConfigurationAsset(deleteConfiguratorConfigurationAssetOptions).execute();
      AssetDeletionStatus assetDeletionStatus = response.getResult();

      System.out.println(assetDeletionStatus);
