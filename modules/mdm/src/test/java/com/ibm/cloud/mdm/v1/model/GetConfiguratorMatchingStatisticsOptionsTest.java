...
/**
 * Unit test class for the GetConfiguratorMatchingStatisticsOptions model.
 */
public class GetConfiguratorMatchingStatisticsOptionsTest {
  ...
  public void testGetConfiguratorMatchingStatisticsOptionsError() throws Throwable {
    new GetConfiguratorMatchingStatisticsOptions.Builder().build();
  }
