...
/**
 * Unit test class for the RelationshipDiscoveryRulesHierarchyUserRules model.
 */
public class RelationshipDiscoveryRulesHierarchyUserRulesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRelationshipDiscoveryRulesHierarchyUserRules() throws Throwable {
    ...
    String json = TestUtilities.serialize(relationshipDiscoveryRulesHierarchyUserRulesModel);

    RelationshipDiscoveryRulesHierarchyUserRules relationshipDiscoveryRulesHierarchyUserRulesModelNew = TestUtilities.deserialize(json, RelationshipDiscoveryRulesHierarchyUserRules.class);
    assertTrue(relationshipDiscoveryRulesHierarchyUserRulesModelNew instanceof RelationshipDiscoveryRulesHierarchyUserRules);
    assertEquals(relationshipDiscoveryRulesHierarchyUserRulesModelNew.parent().toString(), relationshipDiscoveryRulesRulesBuilderWrapperModel.toString());
    assertEquals(relationshipDiscoveryRulesHierarchyUserRulesModelNew.child().toString(), relationshipDiscoveryRulesRulesBuilderWrapperModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRelationshipDiscoveryRulesHierarchyUserRulesError() throws Throwable {
    new RelationshipDiscoveryRulesHierarchyUserRules.Builder().build();
  }
