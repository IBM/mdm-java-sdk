...
/**
 * Unit test class for the GetRecordsOptions model.
 */
public class GetRecordsOptionsTest {
  ...
  public void testGetRecordsOptionsError() throws Throwable {
    new GetRecordsOptions.Builder().build();
  }
