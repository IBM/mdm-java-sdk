...
/**
 * Unit test class for the StartBulkWorkflowRequestSearchCriteria model.
 */
public class StartBulkWorkflowRequestSearchCriteriaTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testStartBulkWorkflowRequestSearchCriteria() throws Throwable {
    ...
    String json = TestUtilities.serialize(startBulkWorkflowRequestSearchCriteriaModel);

    StartBulkWorkflowRequestSearchCriteria startBulkWorkflowRequestSearchCriteriaModelNew = TestUtilities.deserialize(json, StartBulkWorkflowRequestSearchCriteria.class);
    assertTrue(startBulkWorkflowRequestSearchCriteriaModelNew instanceof StartBulkWorkflowRequestSearchCriteria);
    assertEquals(startBulkWorkflowRequestSearchCriteriaModelNew.query().toString(), startBulkWorkflowRequestQueryModel.toString());
    assertEquals(startBulkWorkflowRequestSearchCriteriaModelNew.searchType(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testStartBulkWorkflowRequestSearchCriteriaError() throws Throwable {
    new StartBulkWorkflowRequestSearchCriteria.Builder().build();
  }
