...
/**
 * Unit test class for the ResolveWorkflowOptions model.
 */
public class ResolveWorkflowOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testResolveWorkflowOptions() throws Throwable {
    ...
    ResolveWorkflowOptions resolveWorkflowOptionsModel = new ResolveWorkflowOptions.Builder()
      ...
      .previewOnly(false)
      .build();
    assertEquals(resolveWorkflowOptionsModel.workflowId(), "testString");
    assertEquals(resolveWorkflowOptionsModel.workflowType(), "testString");
    assertEquals(resolveWorkflowOptionsModel.actions(), java.util.Arrays.asList(actionModel));
    assertEquals(resolveWorkflowOptionsModel.comments(), "testString");
    assertEquals(resolveWorkflowOptionsModel.previewOnly(), Boolean.valueOf(false));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testResolveWorkflowOptionsError() throws Throwable {
    new ResolveWorkflowOptions.Builder().build();
  }
