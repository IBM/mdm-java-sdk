...
/**
 * Unit test class for the UiMemberLabelSettings model.
 */
public class UiMemberLabelSettingsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUiMemberLabelSettings() throws Throwable {
    ...
    String json = TestUtilities.serialize(uiMemberLabelSettingsModel);

    UiMemberLabelSettings uiMemberLabelSettingsModelNew = TestUtilities.deserialize(json, UiMemberLabelSettings.class);
    assertTrue(uiMemberLabelSettingsModelNew instanceof UiMemberLabelSettings);
  }
}