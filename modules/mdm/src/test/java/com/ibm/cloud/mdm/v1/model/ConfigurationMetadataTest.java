...
public class ConfigurationMetadataTest {
  ...
  public void testConfigurationMetadata() throws Throwable {
    ...
    assertEquals(configurationMetadataModel.pairAnalysis(), java.util.Collections.singletonMap("key1", java.util.Collections.singletonMap("key1", configurationMetadataEntityModel)));
