...
/**
 * Unit test class for the BulkDeleteRequestSearchCriteria model.
 */
public class BulkDeleteRequestSearchCriteriaTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBulkDeleteRequestSearchCriteria() throws Throwable {
    ...
    String json = TestUtilities.serialize(bulkDeleteRequestSearchCriteriaModel);

    BulkDeleteRequestSearchCriteria bulkDeleteRequestSearchCriteriaModelNew = TestUtilities.deserialize(json, BulkDeleteRequestSearchCriteria.class);
    assertTrue(bulkDeleteRequestSearchCriteriaModelNew instanceof BulkDeleteRequestSearchCriteria);
    assertEquals(bulkDeleteRequestSearchCriteriaModelNew.searchType(), "record");
    assertEquals(bulkDeleteRequestSearchCriteriaModelNew.query().toString(), bulkDeleteRequestSearchCriteriaQueryModel.toString());
  }
}