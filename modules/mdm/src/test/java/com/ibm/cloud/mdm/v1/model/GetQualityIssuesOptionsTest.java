...
/**
 * Unit test class for the GetQualityIssuesOptions model.
 */
public class GetQualityIssuesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetQualityIssuesOptions() throws Throwable {
  ...
  public void testGetQualityIssuesOptionsError() throws Throwable {
    new GetQualityIssuesOptions.Builder().build();
  }
