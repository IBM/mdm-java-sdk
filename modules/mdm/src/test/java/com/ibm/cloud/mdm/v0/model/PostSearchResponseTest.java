...
/**
 * Unit test class for the PostSearchResponse model.
 */
public class PostSearchResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPostSearchResponse() throws Throwable {
    PostSearchResponse postSearchResponseModel = new PostSearchResponse();
    assertNull(postSearchResponseModel.getRecords());
  }
}