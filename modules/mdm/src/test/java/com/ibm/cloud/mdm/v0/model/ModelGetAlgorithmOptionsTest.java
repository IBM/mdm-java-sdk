...
/**
 * Unit test class for the ModelGetAlgorithmOptions model.
 */
public class ModelGetAlgorithmOptionsTest {
  ...
  public void testModelGetAlgorithmOptionsError() throws Throwable {
    new ModelGetAlgorithmOptions.Builder().build();
  }
