...
public class ConfigDataModelTest {
  ...
  public void testConfigDataModel() throws Throwable {
    ...
    assertEquals(configDataModelModelNew.systemProperties().toString(), dataModelSystemPropertiesModel.toString());
    assertEquals(configDataModelModelNew.isModelPublished(), "testString");
    assertEquals(configDataModelModelNew.locale(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testConfigDataModelError() throws Throwable {
    new ConfigDataModel.Builder().build();
  }
