...
/**
 * Unit test class for the UpdateSettings0Options model.
 */
public class UpdateSettings0OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateSettings0Options() throws Throwable {
  ...
  public void testUpdateSettings0OptionsError() throws Throwable {
    new UpdateSettings0Options.Builder().build();
  }
