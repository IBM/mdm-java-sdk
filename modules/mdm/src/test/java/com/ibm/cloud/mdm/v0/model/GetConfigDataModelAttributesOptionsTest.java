...
/**
 * Unit test class for the GetConfigDataModelAttributesOptions model.
 */
public class GetConfigDataModelAttributesOptionsTest {
  ...
  public void testGetConfigDataModelAttributesOptionsError() throws Throwable {
    new GetConfigDataModelAttributesOptions.Builder().build();
  }
