...
public class SearchResultsTest {
  ...
  public void testSearchResults() throws Throwable {
    ...
    assertNull(searchResultsModel.getOffset());
    assertNull(searchResultsModel.getLimit());
    assertNull(searchResultsModel.getFirst());
    assertNull(searchResultsModel.getLast());
    assertNull(searchResultsModel.getPrevious());
    assertNull(searchResultsModel.getNext());
    assertNull(searchResultsModel.getStats());
  }
}