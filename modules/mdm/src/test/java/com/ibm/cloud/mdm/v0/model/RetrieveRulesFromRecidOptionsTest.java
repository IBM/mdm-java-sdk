...
/**
 * Unit test class for the RetrieveRulesFromRecidOptions model.
 */
public class RetrieveRulesFromRecidOptionsTest {
  ...
  public void testRetrieveRulesFromRecidOptionsError() throws Throwable {
    new RetrieveRulesFromRecidOptions.Builder().build();
  }
