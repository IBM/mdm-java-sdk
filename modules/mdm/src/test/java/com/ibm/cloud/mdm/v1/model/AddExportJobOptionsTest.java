...
/**
 * Unit test class for the AddExportJobOptions model.
 */
public class AddExportJobOptionsTest {
  ...
  public void testAddExportJobOptionsError() throws Throwable {
    new AddExportJobOptions.Builder().build();
  }
