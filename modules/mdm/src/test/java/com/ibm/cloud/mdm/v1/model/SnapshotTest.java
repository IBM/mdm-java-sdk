...
public class SnapshotTest {
  ...
  public void testSnapshot() throws Throwable {
    ...
    assertNull(snapshotModel.getAlgorithms());
    assertNull(snapshotModel.getCompareSpecResources());
    assertNull(snapshotModel.getRelationshipDiscoveryRules());
    assertNull(snapshotModel.getMappingPatterns());
    assertNull(snapshotModel.getDataModel());
    assertNull(snapshotModel.getMapResources());
    assertNull(snapshotModel.getSetResources());
    assertNull(snapshotModel.getCompositeRules());
    assertNull(snapshotModel.getSnapshotSummary());
    assertNull(snapshotModel.getMatchSettings());
  }
}