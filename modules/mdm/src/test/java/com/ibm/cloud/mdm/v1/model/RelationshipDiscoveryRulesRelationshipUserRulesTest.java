...
/**
 * Unit test class for the RelationshipDiscoveryRulesRelationshipUserRules model.
 */
public class RelationshipDiscoveryRulesRelationshipUserRulesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRelationshipDiscoveryRulesRelationshipUserRules() throws Throwable {
    ...
    String json = TestUtilities.serialize(relationshipDiscoveryRulesRelationshipUserRulesModel);

    RelationshipDiscoveryRulesRelationshipUserRules relationshipDiscoveryRulesRelationshipUserRulesModelNew = TestUtilities.deserialize(json, RelationshipDiscoveryRulesRelationshipUserRules.class);
    assertTrue(relationshipDiscoveryRulesRelationshipUserRulesModelNew instanceof RelationshipDiscoveryRulesRelationshipUserRules);
    assertEquals(relationshipDiscoveryRulesRelationshipUserRulesModelNew.source().toString(), relationshipDiscoveryRulesRulesBuilderWrapperModel.toString());
    assertEquals(relationshipDiscoveryRulesRelationshipUserRulesModelNew.target().toString(), relationshipDiscoveryRulesRulesBuilderWrapperModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRelationshipDiscoveryRulesRelationshipUserRulesError() throws Throwable {
    new RelationshipDiscoveryRulesRelationshipUserRules.Builder().build();
  }
