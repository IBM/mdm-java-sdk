...
public class ReplaceModelDataModelOptionsTest {
  ...
  public void testReplaceModelDataModelOptions() throws Throwable {
    ...
    assertEquals(replaceModelDataModelOptionsModel.attributeTypes(), java.util.Collections.singletonMap("key1", dataModelAttributeTypeModel));
    assertEquals(replaceModelDataModelOptionsModel.relationshipTypes(), java.util.Collections.singletonMap("key1", dataModelRelationshipTypeModel));
    assertEquals(replaceModelDataModelOptionsModel.locale(), "testString");
    assertEquals(replaceModelDataModelOptionsModel.recordTypes(), java.util.Collections.singletonMap("key1", dataModelRecordTypeModel));
    assertEquals(replaceModelDataModelOptionsModel.hierarchyTypes(), java.util.Collections.singletonMap("key1", dataModelHierarchyTypeModel));
    assertEquals(replaceModelDataModelOptionsModel.nodeTypes(), java.util.Collections.singletonMap("key1", dataModelNodeTypeModel));
    assertEquals(replaceModelDataModelOptionsModel.groupTypes(), java.util.Collections.singletonMap("key1", dataModelGroupTypeModel));
  }
