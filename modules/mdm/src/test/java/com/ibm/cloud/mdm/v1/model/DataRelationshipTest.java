...
public class DataRelationshipTest {
  ...
  public void testDataRelationship() throws Throwable {
    ...
    assertEquals(dataRelationshipModelNew.attributes().toString(), java.util.Collections.singletonMap("anyKey", "anyValue").toString());
    assertEquals(dataRelationshipModelNew.systemAttributes().toString(), java.util.Collections.singletonMap("anyKey", "anyValue").toString());
