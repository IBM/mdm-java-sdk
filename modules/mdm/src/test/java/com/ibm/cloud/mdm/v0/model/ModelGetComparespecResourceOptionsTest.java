...
/**
 * Unit test class for the ModelGetComparespecResourceOptions model.
 */
public class ModelGetComparespecResourceOptionsTest {
  ...
  public void testModelGetComparespecResourceOptionsError() throws Throwable {
    new ModelGetComparespecResourceOptions.Builder().build();
  }
