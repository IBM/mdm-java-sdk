...
public class UpdateModelAlgorithmOptionsTest {
  ...
  public void testUpdateModelAlgorithmOptions() throws Throwable {
    ...
    assertEquals(updateModelAlgorithmOptionsModel.standardizers(), java.util.Collections.singletonMap("key1", algorithmStandardizerModel));
    assertEquals(updateModelAlgorithmOptionsModel.encryption(), algorithmEncryptionModel);
    assertEquals(updateModelAlgorithmOptionsModel.entityTypes(), java.util.Collections.singletonMap("key1", algorithmEntityTypeModel));
    assertEquals(updateModelAlgorithmOptionsModel.locale(), "testString");
    assertEquals(updateModelAlgorithmOptionsModel.bucketGroupBitLength(), Long.valueOf("26"));
  }
