...
/**
 * Unit test class for the GetConfiguratorProcessOptions model.
 */
public class GetConfiguratorProcessOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetConfiguratorProcessOptions() throws Throwable {
  ...
  public void testGetConfiguratorProcessOptionsError() throws Throwable {
    new GetConfiguratorProcessOptions.Builder().build();
  }
