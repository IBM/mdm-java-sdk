...
public class ListConfiguratorPairDecisionOptionsTest {
  ...
  public void testListConfiguratorPairDecisionOptions() throws Throwable {
    ...
    assertEquals(listConfiguratorPairDecisionOptionsModel.entityType(), "testString");
    ...
    assertEquals(listConfiguratorPairDecisionOptionsModel.offset(), "testString");
    assertEquals(listConfiguratorPairDecisionOptionsModel.limit(), "testString");
  }
