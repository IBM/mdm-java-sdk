...
public class WorkflowConfigurationTest {
  ...
  public void testWorkflowConfiguration() throws Throwable {
    ...
    assertEquals(workflowConfigurationModel.applicableDataTypes(), java.util.Collections.singletonMap("anyKey", "anyValue"));
    assertEquals(workflowConfigurationModel.customTags(), java.util.Collections.singletonMap("anyKey", "anyValue"));
    ...
    assertEquals(workflowConfigurationModelNew.applicableDataTypes().toString(), java.util.Collections.singletonMap("anyKey", "anyValue").toString());
    assertEquals(workflowConfigurationModelNew.customTags().toString(), java.util.Collections.singletonMap("anyKey", "anyValue").toString());
