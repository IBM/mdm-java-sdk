...
/**
 * Unit test class for the WorkflowConfiguration model.
 */
public class WorkflowConfigurationTest {
  ...
  @Test
  public void testWorkflowConfiguration() throws Throwable {
    ...
    WorkflowConfiguration workflowConfigurationModel = new WorkflowConfiguration.Builder()
      ...
      .build();
    assertEquals(workflowConfigurationModel.autoCreateTasks(), Boolean.valueOf(true));
    assertEquals(workflowConfigurationModel.description(), "testString");
    assertEquals(workflowConfigurationModel.applicableDataTypes(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
    assertEquals(workflowConfigurationModel.customTags(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
    assertEquals(workflowConfigurationModel.maxAccumulatedUpdates(), Long.valueOf("26"));
    assertEquals(workflowConfigurationModel.triggerOperator(), workflowConfigurationTriggerOperatorModel);

    String json = TestUtilities.serialize(workflowConfigurationModel);

    WorkflowConfiguration workflowConfigurationModelNew = TestUtilities.deserialize(json, WorkflowConfiguration.class);
    assertTrue(workflowConfigurationModelNew instanceof WorkflowConfiguration);
    assertEquals(workflowConfigurationModelNew.autoCreateTasks(), Boolean.valueOf(true));
    assertEquals(workflowConfigurationModelNew.description(), "testString");
    assertEquals(workflowConfigurationModelNew.applicableDataTypes().toString(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } }.toString());
    assertEquals(workflowConfigurationModelNew.customTags().toString(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } }.toString());
    assertEquals(workflowConfigurationModelNew.maxAccumulatedUpdates(), Long.valueOf("26"));
    assertEquals(workflowConfigurationModelNew.triggerOperator().toString(), workflowConfigurationTriggerOperatorModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testWorkflowConfigurationError() throws Throwable {
    new WorkflowConfiguration.Builder().build();
  }
