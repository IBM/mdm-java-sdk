...
public class ReplaceModelAlgorithmOptionsTest {
  ...
  public void testReplaceModelAlgorithmOptions() throws Throwable {
    ...
    assertEquals(replaceModelAlgorithmOptionsModel.standardizers(), java.util.Collections.singletonMap("key1", algorithmStandardizerModel));
    assertEquals(replaceModelAlgorithmOptionsModel.encryption(), algorithmEncryptionModel);
    assertEquals(replaceModelAlgorithmOptionsModel.entityTypes(), java.util.Collections.singletonMap("key1", algorithmEntityTypeModel));
    assertEquals(replaceModelAlgorithmOptionsModel.locale(), "testString");
    assertEquals(replaceModelAlgorithmOptionsModel.bucketGroupBitLength(), Long.valueOf("26"));
  }
