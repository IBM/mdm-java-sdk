...
/**
 * Unit test class for the RelationshipDiscoveryRulesHierarchyGeneratedRules model.
 */
public class RelationshipDiscoveryRulesHierarchyGeneratedRulesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRelationshipDiscoveryRulesHierarchyGeneratedRules() throws Throwable {
    ...
    String json = TestUtilities.serialize(relationshipDiscoveryRulesHierarchyGeneratedRulesModel);

    RelationshipDiscoveryRulesHierarchyGeneratedRules relationshipDiscoveryRulesHierarchyGeneratedRulesModelNew = TestUtilities.deserialize(json, RelationshipDiscoveryRulesHierarchyGeneratedRules.class);
    assertTrue(relationshipDiscoveryRulesHierarchyGeneratedRulesModelNew instanceof RelationshipDiscoveryRulesHierarchyGeneratedRules);
    assertEquals(relationshipDiscoveryRulesHierarchyGeneratedRulesModelNew.parent().toString(), relationshipDiscoveryRulesGeneratedRulesWrapperModel.toString());
    assertEquals(relationshipDiscoveryRulesHierarchyGeneratedRulesModelNew.child().toString(), relationshipDiscoveryRulesGeneratedRulesWrapperModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRelationshipDiscoveryRulesHierarchyGeneratedRulesError() throws Throwable {
    new RelationshipDiscoveryRulesHierarchyGeneratedRules.Builder().build();
  }
