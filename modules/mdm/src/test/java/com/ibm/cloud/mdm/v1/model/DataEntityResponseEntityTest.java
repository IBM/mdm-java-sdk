...
/**
 * Unit test class for the DataEntityResponseEntity model.
 */
public class DataEntityResponseEntityTest {
  ...
  public void testDataEntityResponseEntity() throws Throwable {
    ...
    DataEntityResponseEntity dataEntityResponseEntityModelNew = TestUtilities.deserialize(json, DataEntityResponseEntity.class);
    assertTrue(dataEntityResponseEntityModelNew instanceof DataEntityResponseEntity);
    assertEquals(dataEntityResponseEntityModelNew.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDataEntityResponseEntityError() throws Throwable {
    new DataEntityResponseEntity.Builder().build();
  }
