...
/**
 * Unit test class for the SyncUpdateRequestDeletions model.
 */
public class SyncUpdateRequestDeletionsTest {
  ...
  public void testSyncUpdateRequestDeletions() throws Throwable {
    ...
    SyncUpdateRequestDeletions syncUpdateRequestDeletionsModelNew = TestUtilities.deserialize(json, SyncUpdateRequestDeletions.class);
    assertTrue(syncUpdateRequestDeletionsModelNew instanceof SyncUpdateRequestDeletions);
  }
}