...
/**
 * Unit test class for the UpdateDataHierarchyOptions model.
 */
public class UpdateDataHierarchyOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDataHierarchyOptions() throws Throwable {
    ...
    UpdateDataHierarchyOptions updateDataHierarchyOptionsModel = new UpdateDataHierarchyOptions.Builder()
      ...
      .build();
    assertEquals(updateDataHierarchyOptionsModel.id(), Long.valueOf("26"));
    assertEquals(updateDataHierarchyOptionsModel.hierarchyType(), "testString");
    assertEquals(updateDataHierarchyOptionsModel.upserts(), patchHierarchyUpsertsModel);
    assertEquals(updateDataHierarchyOptionsModel.deletions(), patchHierarchyDeletionsModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateDataHierarchyOptionsError() throws Throwable {
    new UpdateDataHierarchyOptions.Builder().build();
  }
