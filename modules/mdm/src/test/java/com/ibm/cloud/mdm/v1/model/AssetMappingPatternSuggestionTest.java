...
/**
 * Unit test class for the AssetMappingPatternSuggestion model.
 */
public class AssetMappingPatternSuggestionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAssetMappingPatternSuggestion() throws Throwable {
    ...
    String json = TestUtilities.serialize(assetMappingPatternSuggestionModel);

    AssetMappingPatternSuggestion assetMappingPatternSuggestionModelNew = TestUtilities.deserialize(json, AssetMappingPatternSuggestion.class);
    assertTrue(assetMappingPatternSuggestionModelNew instanceof AssetMappingPatternSuggestion);
    assertEquals(assetMappingPatternSuggestionModelNew.mappingPatternId(), "0e4bb17d-4871-40a5-b5a1-0000000");
    assertEquals(assetMappingPatternSuggestionModelNew.mappingPatternHash(), "0b74893612bc657fbdb89eb0e9b2ab4a515b60ffaa43910c2ef40f19ede33929");
    assertEquals(assetMappingPatternSuggestionModelNew.mappingPatternName(), "testString");
    assertEquals(assetMappingPatternSuggestionModelNew.sourceOfMapping(), "active_snapshot, config_metadata");
    assertEquals(assetMappingPatternSuggestionModelNew.assetRecordType(), "testString");
    assertEquals(assetMappingPatternSuggestionModelNew.assetType(), "testString");
    assertEquals(assetMappingPatternSuggestionModelNew.mappingPatternLastUpdatedDate(), "testString");
  }
}