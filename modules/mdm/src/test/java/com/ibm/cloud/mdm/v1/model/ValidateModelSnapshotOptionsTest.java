...
/**
 * Unit test class for the ValidateModelSnapshotOptions model.
 */
public class ValidateModelSnapshotOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testValidateModelSnapshotOptions() throws Throwable {
  ...
  public void testValidateModelSnapshotOptionsError() throws Throwable {
    new ValidateModelSnapshotOptions.Builder().build();
  }
