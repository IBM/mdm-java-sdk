...
/**
 * Unit test class for the AddRuleOptions model.
 */
public class AddRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAddRuleOptions() throws Throwable {
    ...
    AddRuleOptions addRuleOptionsModel = new AddRuleOptions.Builder()
      ...
      .build();
    assertEquals(addRuleOptionsModel.crn(), "testString");
  ...
  public void testAddRuleOptionsError() throws Throwable {
    new AddRuleOptions.Builder().build();
  }
