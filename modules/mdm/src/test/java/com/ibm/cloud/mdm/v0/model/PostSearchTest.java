...
/**
 * Unit test class for the PostSearch model.
 */
public class PostSearchTest {
  ...
  @Test
  public void testPostSearch() throws Throwable {
    PostSearch postSearchModel = new PostSearch();
    assertNull(postSearchModel.getRecords());
  }
}