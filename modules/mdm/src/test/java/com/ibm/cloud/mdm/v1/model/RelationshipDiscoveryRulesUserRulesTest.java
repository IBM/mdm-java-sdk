...
/**
 * Unit test class for the RelationshipDiscoveryRulesUserRules model.
 */
public class RelationshipDiscoveryRulesUserRulesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRelationshipDiscoveryRulesUserRules() throws Throwable {
    ...
    String json = TestUtilities.serialize(relationshipDiscoveryRulesUserRulesModel);

    RelationshipDiscoveryRulesUserRules relationshipDiscoveryRulesUserRulesModelNew = TestUtilities.deserialize(json, RelationshipDiscoveryRulesUserRules.class);
    assertTrue(relationshipDiscoveryRulesUserRulesModelNew instanceof RelationshipDiscoveryRulesUserRules);
    assertEquals(relationshipDiscoveryRulesUserRulesModelNew.hierarchy().toString(), relationshipDiscoveryRulesHierarchyUserRulesModel.toString());
    assertEquals(relationshipDiscoveryRulesUserRulesModelNew.relationship().toString(), relationshipDiscoveryRulesRelationshipUserRulesModel.toString());
    assertEquals(relationshipDiscoveryRulesUserRulesModelNew.group().toString(), relationshipDiscoveryRulesGroupUserRulesModel.toString());
  }
}