...
/**
 * Unit test class for the RevokeDataBucketCredentialsOptions model.
 */
public class RevokeDataBucketCredentialsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRevokeDataBucketCredentialsOptions() throws Throwable {
    ...
    RevokeDataBucketCredentialsOptions revokeDataBucketCredentialsOptionsModel = new RevokeDataBucketCredentialsOptions.Builder()
      ...
      .build();
    assertEquals(revokeDataBucketCredentialsOptionsModel.bucketCredentials(), bucketCredentialsRequestBucketCredentialsModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRevokeDataBucketCredentialsOptionsError() throws Throwable {
    new RevokeDataBucketCredentialsOptions.Builder().build();
  }
