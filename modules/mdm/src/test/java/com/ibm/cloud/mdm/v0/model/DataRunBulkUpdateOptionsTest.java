...
/**
 * Unit test class for the DataRunBulkUpdateOptions model.
 */
public class DataRunBulkUpdateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataRunBulkUpdateOptions() throws Throwable {
    ...
    DataRunBulkUpdateOptions dataRunBulkUpdateOptionsModel = new DataRunBulkUpdateOptions.Builder()
      ...
      .build();
    assertEquals(dataRunBulkUpdateOptionsModel.upserts(), syncUpdateElementModel);
    assertEquals(dataRunBulkUpdateOptionsModel.deletions(), syncUpdateElementModel);
    assertEquals(dataRunBulkUpdateOptionsModel.ignoreRedundantUpdates(), Boolean.valueOf(true));
  }
}