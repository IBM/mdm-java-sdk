...
/**
 * Unit test class for the ResiliencyRulesLinkResiliencyRules model.
 */
public class ResiliencyRulesLinkResiliencyRulesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testResiliencyRulesLinkResiliencyRules() throws Throwable {
    ...
    String json = TestUtilities.serialize(resiliencyRulesLinkResiliencyRulesModel);

    ResiliencyRulesLinkResiliencyRules resiliencyRulesLinkResiliencyRulesModelNew = TestUtilities.deserialize(json, ResiliencyRulesLinkResiliencyRules.class);
    assertTrue(resiliencyRulesLinkResiliencyRulesModelNew instanceof ResiliencyRulesLinkResiliencyRules);
    assertEquals(resiliencyRulesLinkResiliencyRulesModelNew.entities().toString(), java.util.Collections.singletonMap("anyKey", "anyValue").toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testResiliencyRulesLinkResiliencyRulesError() throws Throwable {
    new ResiliencyRulesLinkResiliencyRules.Builder().build();
  }
