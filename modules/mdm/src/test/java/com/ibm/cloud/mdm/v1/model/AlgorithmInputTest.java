...
/**
 * Unit test class for the AlgorithmInput model.
 */
public class AlgorithmInputTest {
  ...
  public void testAlgorithmInput() throws Throwable {
    ...
    AlgorithmInput algorithmInputModelNew = TestUtilities.deserialize(json, AlgorithmInput.class);
    assertTrue(algorithmInputModelNew instanceof AlgorithmInput);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testAlgorithmInputError() throws Throwable {
    new AlgorithmInput.Builder().build();
  }
