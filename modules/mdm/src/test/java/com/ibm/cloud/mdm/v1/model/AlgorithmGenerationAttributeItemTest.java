...
/**
 * Unit test class for the AlgorithmGenerationAttributeItem model.
 */
public class AlgorithmGenerationAttributeItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAlgorithmGenerationAttributeItem() throws Throwable {
    ...
    String json = TestUtilities.serialize(algorithmGenerationAttributeItemModel);

    AlgorithmGenerationAttributeItem algorithmGenerationAttributeItemModelNew = TestUtilities.deserialize(json, AlgorithmGenerationAttributeItem.class);
    assertTrue(algorithmGenerationAttributeItemModelNew instanceof AlgorithmGenerationAttributeItem);
    assertEquals(algorithmGenerationAttributeItemModelNew.overallScoreContribution(), Boolean.valueOf(true));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testAlgorithmGenerationAttributeItemError() throws Throwable {
    new AlgorithmGenerationAttributeItem.Builder().build();
  }
