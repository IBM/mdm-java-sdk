...
/**
 * Unit test class for the AlgorithmPostFilterWeight model.
 */
public class AlgorithmPostFilterWeightTest {
  ...
  public void testAlgorithmPostFilterWeight() throws Throwable {
    ...
    AlgorithmPostFilterWeight algorithmPostFilterWeightModelNew = TestUtilities.deserialize(json, AlgorithmPostFilterWeight.class);
    assertTrue(algorithmPostFilterWeightModelNew instanceof AlgorithmPostFilterWeight);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testAlgorithmPostFilterWeightError() throws Throwable {
    new AlgorithmPostFilterWeight.Builder().build();
  }
