...
public class AlgorithmEntityTypeTest {
  ...
  public void testAlgorithmEntityType() throws Throwable {
    ...
    assertEquals(algorithmEntityTypeModelNew.glueThreshold(), Float.valueOf("36.0"));
    assertEquals(algorithmEntityTypeModelNew.recordFilter().toString(), algorithmRecordFilterModel.toString());
