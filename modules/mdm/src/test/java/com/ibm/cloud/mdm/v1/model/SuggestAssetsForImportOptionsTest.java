...
/**
 * Unit test class for the SuggestAssetsForImportOptions model.
 */
public class SuggestAssetsForImportOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSuggestAssetsForImportOptions() throws Throwable {
    ...
    SuggestAssetsForImportOptions suggestAssetsForImportOptionsModel = new SuggestAssetsForImportOptions.Builder()
      ...
      .build();
    assertEquals(suggestAssetsForImportOptionsModel.mappingPatterns(), java.util.Arrays.asList(assetMappingPatternSuggestionModel));
  }
}