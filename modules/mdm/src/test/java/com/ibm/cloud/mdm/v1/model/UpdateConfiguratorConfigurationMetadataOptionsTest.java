...
public class UpdateConfiguratorConfigurationMetadataOptionsTest {
  ...
  public void testUpdateConfiguratorConfigurationMetadataOptions() throws Throwable {
    ...
    assertEquals(updateConfiguratorConfigurationMetadataOptionsModel.pairAnalysis(), java.util.Collections.singletonMap("key1", java.util.Collections.singletonMap("key1", configurationMetadataEntityModel)));
  }
}