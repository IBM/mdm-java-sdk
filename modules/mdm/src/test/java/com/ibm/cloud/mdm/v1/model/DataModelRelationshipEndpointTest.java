...
/**
 * Unit test class for the DataModelRelationshipEndpoint model.
 */
public class DataModelRelationshipEndpointTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataModelRelationshipEndpoint() throws Throwable {
    ...
    String json = TestUtilities.serialize(dataModelRelationshipEndpointModel);

    DataModelRelationshipEndpoint dataModelRelationshipEndpointModelNew = TestUtilities.deserialize(json, DataModelRelationshipEndpoint.class);
    assertTrue(dataModelRelationshipEndpointModelNew instanceof DataModelRelationshipEndpoint);
  }
}