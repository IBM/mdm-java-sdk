...
/**
 * Unit test class for the WorkflowConfigurationRecordTypeTriggerOperator model.
 */
public class WorkflowConfigurationRecordTypeTriggerOperatorTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testWorkflowConfigurationRecordTypeTriggerOperator() throws Throwable {
    ...
    String json = TestUtilities.serialize(workflowConfigurationRecordTypeTriggerOperatorModel);

    WorkflowConfigurationRecordTypeTriggerOperator workflowConfigurationRecordTypeTriggerOperatorModelNew = TestUtilities.deserialize(json, WorkflowConfigurationRecordTypeTriggerOperator.class);
    assertTrue(workflowConfigurationRecordTypeTriggerOperatorModelNew instanceof WorkflowConfigurationRecordTypeTriggerOperator);
    assertEquals(workflowConfigurationRecordTypeTriggerOperatorModelNew.name(), "testString");
    assertEquals(workflowConfigurationRecordTypeTriggerOperatorModelNew.workflowConfigurations().toString(), workflowConfigurationWorkflowConfigurationsModel.toString());
    assertEquals(workflowConfigurationRecordTypeTriggerOperatorModelNew.maxTasks(), Float.valueOf("36.0"));
    assertEquals(workflowConfigurationRecordTypeTriggerOperatorModelNew.status(), "testString");
  }
}