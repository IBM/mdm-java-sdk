...
public class SnapshotImportRequestTest {
  ...
  public void testSnapshotImportRequest() throws Throwable {
    ...
    SnapshotImportRequest snapshotImportRequestModel = new SnapshotImportRequest.Builder()
      ...
      .build();
    assertEquals(snapshotImportRequestModel.algorithms(), new java.util.HashMap<String, Algorithm>() { { put("foo", algorithmModel); } });
    assertEquals(snapshotImportRequestModel.compareSpecResources(), new java.util.HashMap<String, CompareSpecResource>() { { put("foo", compareSpecResourceModel); } });
    assertEquals(snapshotImportRequestModel.relationshipDiscoveryRules(), new java.util.HashMap<String, RelationshipDiscoveryRules>() { { put("foo", relationshipDiscoveryRulesModel); } });
    assertEquals(snapshotImportRequestModel.dataModel(), dataModelModel);
    assertEquals(snapshotImportRequestModel.mapResources(), new java.util.HashMap<String, Map<String, List<MapResourceEntry>>>() { { put("foo", new java.util.HashMap<String, List<MapResourceEntry>>() { { put("foo", java.util.Arrays.asList(mapResourceEntryModel)); } }); } });
    assertEquals(snapshotImportRequestModel.setResources(), new java.util.HashMap<String, Map<String, SetResourceEntry>>() { { put("foo", new java.util.HashMap<String, SetResourceEntry>() { { put("foo", setResourceEntryModel); } }); } });
