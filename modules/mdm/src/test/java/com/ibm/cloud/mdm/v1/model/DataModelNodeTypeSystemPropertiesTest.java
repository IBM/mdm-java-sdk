...
/**
 * Unit test class for the DataModelNodeTypeSystemProperties model.
 */
public class DataModelNodeTypeSystemPropertiesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataModelNodeTypeSystemProperties() throws Throwable {
    ...
    String json = TestUtilities.serialize(dataModelNodeTypeSystemPropertiesModel);

    DataModelNodeTypeSystemProperties dataModelNodeTypeSystemPropertiesModelNew = TestUtilities.deserialize(json, DataModelNodeTypeSystemProperties.class);
    assertTrue(dataModelNodeTypeSystemPropertiesModelNew instanceof DataModelNodeTypeSystemProperties);
    assertEquals(dataModelNodeTypeSystemPropertiesModelNew.nodeNumber().toString(), dataModelSystemPropertyModel.toString());
    assertEquals(dataModelNodeTypeSystemPropertiesModelNew.createdUser().toString(), dataModelSystemPropertyModel.toString());
    assertEquals(dataModelNodeTypeSystemPropertiesModelNew.lastUpdatedUser().toString(), dataModelSystemPropertyModel.toString());
    assertEquals(dataModelNodeTypeSystemPropertiesModelNew.contextId().toString(), dataModelSystemPropertyModel.toString());
    assertEquals(dataModelNodeTypeSystemPropertiesModelNew.createdDate().toString(), dataModelSystemPropertyModel.toString());
    assertEquals(dataModelNodeTypeSystemPropertiesModelNew.lastUpdatedDate().toString(), dataModelSystemPropertyModel.toString());
  }
}