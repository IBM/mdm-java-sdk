...
/**
 * Unit test class for the UICard model.
 */
public class UICardTest {
  ...
  @Test
  public void testUICard() throws Throwable {
    ...
    String json = TestUtilities.serialize(uiCardModel);

    UICard uiCardModelNew = TestUtilities.deserialize(json, UICard.class);
    assertTrue(uiCardModelNew instanceof UICard);
    assertEquals(uiCardModelNew.label(), "testString");
    assertEquals(uiCardModelNew.recordType(), "testString");
    assertEquals(uiCardModelNew.resultType(), "testString");
    assertEquals(uiCardModelNew.show(), Boolean.valueOf(true));
    assertEquals(uiCardModelNew.type(), "testString");
    assertEquals(uiCardModelNew.entityType(), "testString");
  }
}