...
/**
 * Unit test class for the UiLabelSettings model.
 */
public class UiLabelSettingsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUiLabelSettings() throws Throwable {
    ...
    String json = TestUtilities.serialize(uiLabelSettingsModel);

    UiLabelSettings uiLabelSettingsModelNew = TestUtilities.deserialize(json, UiLabelSettings.class);
    assertTrue(uiLabelSettingsModelNew instanceof UiLabelSettings);
    assertEquals(uiLabelSettingsModelNew.summary().toString(), uiSummaryModel.toString());
    assertEquals(uiLabelSettingsModelNew.hierarchyLabel().toString(), uiCustomEnabledLabelSettingModel.toString());
    assertEquals(uiLabelSettingsModelNew.memberLabel().toString(), uiMemberLabelSettingsModel.toString());
  }
}