...
/**
 * Unit test class for the JsonUISettingsResponse model.
 */
public class JsonUISettingsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testJsonUISettingsResponse() throws Throwable {
    JsonUISettingsResponse jsonUiSettingsResponseModel = new JsonUISettingsResponse();
    assertNull(jsonUiSettingsResponseModel.getUiSettings());
    assertNull(jsonUiSettingsResponseModel.getMetadata());
  }
}