...
/**
 * Unit test class for the UIRecordType model.
 */
public class UIRecordTypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUIRecordType() throws Throwable {
    ...
    String json = TestUtilities.serialize(uiRecordTypeModel);

    UIRecordType uiRecordTypeModelNew = TestUtilities.deserialize(json, UIRecordType.class);
    assertTrue(uiRecordTypeModelNew instanceof UIRecordType);
    assertEquals(uiRecordTypeModelNew.summary().toString(), uiSummaryModel.toString());
  }
}