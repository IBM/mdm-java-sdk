...
/**
 * Unit test class for the ReplaceModelResiliencyRulesOptions model.
 */
public class ReplaceModelResiliencyRulesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceModelResiliencyRulesOptions() throws Throwable {
    ...
    ReplaceModelResiliencyRulesOptions replaceModelResiliencyRulesOptionsModel = new ReplaceModelResiliencyRulesOptions.Builder()
      ...
      .build();
    assertEquals(replaceModelResiliencyRulesOptionsModel.linkResiliencyRules(), resiliencyRulesLinkResiliencyRulesModel);
  }
}