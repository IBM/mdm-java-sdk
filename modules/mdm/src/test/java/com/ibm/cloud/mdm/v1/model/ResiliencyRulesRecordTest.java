...
/**
 * Unit test class for the ResiliencyRulesRecord model.
 */
public class ResiliencyRulesRecordTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testResiliencyRulesRecord() throws Throwable {
    ...
    String json = TestUtilities.serialize(resiliencyRulesRecordModel);

    ResiliencyRulesRecord resiliencyRulesRecordModelNew = TestUtilities.deserialize(json, ResiliencyRulesRecord.class);
    assertTrue(resiliencyRulesRecordModelNew instanceof ResiliencyRulesRecord);
    assertEquals(resiliencyRulesRecordModelNew.add().toString(), resiliencyRulesAddModel.toString());
    assertEquals(resiliencyRulesRecordModelNew.update().toString(), resiliencyRulesUpdateModel.toString());
    assertEquals(resiliencyRulesRecordModelNew.manualLink().toString(), resiliencyRulesManualLinkModel.toString());
    assertEquals(resiliencyRulesRecordModelNew.delete().toString(), resiliencyRulesDeleteModel.toString());
    assertEquals(resiliencyRulesRecordModelNew.manualUnlink().toString(), resiliencyRulesManualUnlinkModel.toString());
  }
}