...
/**
 * Unit test class for the PatchWorkflowOptions model.
 */
public class PatchWorkflowOptionsTest {
  ...
  public void testPatchWorkflowOptions() throws Throwable {
    ...
    PatchWorkflowOptions patchWorkflowOptionsModel = new PatchWorkflowOptions.Builder()
      ...
      .build();
    assertEquals(patchWorkflowOptionsModel.workflowId(), "testString");
    assertEquals(patchWorkflowOptionsModel.workflowType(), "testString");
    assertEquals(patchWorkflowOptionsModel.actions(), java.util.Arrays.asList(actionElementModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testPatchWorkflowOptionsError() throws Throwable {
    new PatchWorkflowOptions.Builder().build();
  }
