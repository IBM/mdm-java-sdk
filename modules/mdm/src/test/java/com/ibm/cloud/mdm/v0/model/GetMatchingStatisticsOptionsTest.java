...
/**
 * Unit test class for the GetMatchingStatisticsOptions model.
 */
public class GetMatchingStatisticsOptionsTest {
  ...
  public void testGetMatchingStatisticsOptionsError() throws Throwable {
    new GetMatchingStatisticsOptions.Builder().build();
  }
