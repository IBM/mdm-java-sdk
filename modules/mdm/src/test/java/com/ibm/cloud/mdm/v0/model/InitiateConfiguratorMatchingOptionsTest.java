...
/**
 * Unit test class for the InitiateConfiguratorMatchingOptions model.
 */
public class InitiateConfiguratorMatchingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInitiateConfiguratorMatchingOptions() throws Throwable {
  ...
  public void testInitiateConfiguratorMatchingOptionsError() throws Throwable {
    new InitiateConfiguratorMatchingOptions.Builder().build();
  }
