...
/**
 * Unit test class for the SearchQueryRequest model.
 */
public class SearchQueryRequestTest {
  ...
  @Test
  public void testSearchQueryRequest() throws Throwable {
    ...
    String json = TestUtilities.serialize(searchQueryRequestModel);

    SearchQueryRequest searchQueryRequestModelNew = TestUtilities.deserialize(json, SearchQueryRequest.class);
    assertTrue(searchQueryRequestModelNew instanceof SearchQueryRequest);
    assertEquals(searchQueryRequestModelNew.operation(), "and");
  }
}