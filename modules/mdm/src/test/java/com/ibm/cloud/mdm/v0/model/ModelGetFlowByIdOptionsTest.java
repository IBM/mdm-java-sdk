...
/**
 * Unit test class for the ModelGetFlowByIdOptions model.
 */
public class ModelGetFlowByIdOptionsTest {
  ...
  public void testModelGetFlowByIdOptionsError() throws Throwable {
    new ModelGetFlowByIdOptions.Builder().build();
  }
