...
/**
 * Unit test class for the GetCloudJobSummaryOptions model.
 */
public class GetCloudJobSummaryOptionsTest {
  ...
  public void testGetCloudJobSummaryOptionsError() throws Throwable {
    new GetCloudJobSummaryOptions.Builder().build();
  }
