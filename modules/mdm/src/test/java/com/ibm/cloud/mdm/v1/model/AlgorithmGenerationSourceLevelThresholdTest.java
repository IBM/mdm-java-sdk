...
/**
 * Unit test class for the AlgorithmGenerationSourceLevelThreshold model.
 */
public class AlgorithmGenerationSourceLevelThresholdTest {
  ...
  public void testAlgorithmGenerationSourceLevelThreshold() throws Throwable {
    ...
    AlgorithmGenerationSourceLevelThreshold algorithmGenerationSourceLevelThresholdModelNew = TestUtilities.deserialize(json, AlgorithmGenerationSourceLevelThreshold.class);
    assertTrue(algorithmGenerationSourceLevelThresholdModelNew instanceof AlgorithmGenerationSourceLevelThreshold);
  }
}