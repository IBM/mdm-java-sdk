...
/**
 * Unit test class for the GetModelAlgorithmOptions model.
 */
public class GetModelAlgorithmOptionsTest {
  ...
  public void testGetModelAlgorithmOptionsError() throws Throwable {
    new GetModelAlgorithmOptions.Builder().build();
  }
