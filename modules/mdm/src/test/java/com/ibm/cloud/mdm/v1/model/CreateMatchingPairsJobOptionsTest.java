...
public class CreateMatchingPairsJobOptionsTest {
  ...
  public void testCreateMatchingPairsJobOptions() throws Throwable {
    ...
    assertEquals(createMatchingPairsJobOptionsModel.maxPairs(), "500");
    ...
    assertEquals(createMatchingPairsJobOptionsModel.sparkParallelism(), Long.valueOf("2"));
    assertEquals(createMatchingPairsJobOptionsModel.excludeReviewedPairs(), Boolean.valueOf(false));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateMatchingPairsJobOptionsError() throws Throwable {
    new CreateMatchingPairsJobOptions.Builder().build();
  }
