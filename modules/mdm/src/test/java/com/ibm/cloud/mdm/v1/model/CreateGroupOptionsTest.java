...
/**
 * Unit test class for the CreateGroupOptions model.
 */
public class CreateGroupOptionsTest {
  ...
  @Test
  public void testCreateGroupOptions() throws Throwable {
    ...
    CreateGroupOptions createGroupOptionsModel = new CreateGroupOptions.Builder()
      ...
      .build();
    assertEquals(createGroupOptionsModel.type(), "group");
    assertEquals(createGroupOptionsModel.attributes(), new java.util.HashMap<String, Object>() { { put("foo", TestUtilities.createMockMap()); } });
    assertEquals(createGroupOptionsModel.typeName(), "testString");
    assertEquals(createGroupOptionsModel.systemAttributes(), new java.util.HashMap<String, Object>() { { put("foo", TestUtilities.createMockMap()); } });
    assertEquals(createGroupOptionsModel.groupAssociations(), java.util.Arrays.asList(dataRelationshipModel));
    assertEquals(createGroupOptionsModel.groupNumber(), Long.valueOf("26"));
    assertEquals(createGroupOptionsModel.memberCount(), Long.valueOf("26"));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateGroupOptionsError() throws Throwable {
    new CreateGroupOptions.Builder().build();
  }
