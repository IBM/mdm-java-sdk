...
public class CreateGroupOptionsTest {
  ...
  public void testCreateGroupOptions() throws Throwable {
    ...
    assertEquals(createGroupOptionsModel.attributes(), java.util.Collections.singletonMap("anyKey", "anyValue"));
    assertEquals(createGroupOptionsModel.typeName(), "testString");
    assertEquals(createGroupOptionsModel.systemAttributes(), java.util.Collections.singletonMap("anyKey", "anyValue"));
