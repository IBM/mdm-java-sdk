...
/**
 * Unit test class for the ExportRequestIncludeAttributes model.
 */
public class ExportRequestIncludeAttributesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testExportRequestIncludeAttributes() throws Throwable {
    ...
    String json = TestUtilities.serialize(exportRequestIncludeAttributesModel);

    ExportRequestIncludeAttributes exportRequestIncludeAttributesModelNew = TestUtilities.deserialize(json, ExportRequestIncludeAttributes.class);
    assertTrue(exportRequestIncludeAttributesModelNew instanceof ExportRequestIncludeAttributes);
  }
}