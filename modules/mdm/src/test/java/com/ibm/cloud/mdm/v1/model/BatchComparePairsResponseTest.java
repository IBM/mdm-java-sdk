...
/**
 * Unit test class for the BatchComparePairsResponse model.
 */
public class BatchComparePairsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBatchComparePairsResponse() throws Throwable {
    BatchComparePairsResponse batchComparePairsResponseModel = new BatchComparePairsResponse();
    assertNull(batchComparePairsResponseModel.getComparisonDetails());
  }
}