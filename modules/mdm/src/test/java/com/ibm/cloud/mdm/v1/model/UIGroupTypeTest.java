...
/**
 * Unit test class for the UIGroupType model.
 */
public class UIGroupTypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUIGroupType() throws Throwable {
    ...
    String json = TestUtilities.serialize(uiGroupTypeModel);

    UIGroupType uiGroupTypeModelNew = TestUtilities.deserialize(json, UIGroupType.class);
    assertTrue(uiGroupTypeModelNew instanceof UIGroupType);
    assertEquals(uiGroupTypeModelNew.summary().toString(), uiSummaryModel.toString());
  }
}