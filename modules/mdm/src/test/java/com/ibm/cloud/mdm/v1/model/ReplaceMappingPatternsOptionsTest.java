...
/**
 * Unit test class for the ReplaceMappingPatternsOptions model.
 */
public class ReplaceMappingPatternsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceMappingPatternsOptions() throws Throwable {
    ...
    ReplaceMappingPatternsOptions replaceMappingPatternsOptionsModel = new ReplaceMappingPatternsOptions.Builder()
      ...
      .build();
    assertEquals(replaceMappingPatternsOptionsModel.id(), "testString");
    assertEquals(replaceMappingPatternsOptionsModel.lastUpdatedAt(), "testString");
    assertEquals(replaceMappingPatternsOptionsModel.mappingPatterns(), java.util.Arrays.asList(assetMappingPatternSuggestionModel));
  }
}