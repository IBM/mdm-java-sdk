...
/**
 * Unit test class for the ListDataRecordsOptions model.
 */
public class ListDataRecordsOptionsTest {
  ...
  public void testListDataRecordsOptions() throws Throwable {
    ListDataRecordsOptions listDataRecordsOptionsModel = new ListDataRecordsOptions.Builder()
      ...
      .build();
    assertEquals(listDataRecordsOptionsModel.offset(), Long.valueOf("10000"));
