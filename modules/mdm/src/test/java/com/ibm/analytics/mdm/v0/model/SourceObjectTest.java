...
/**
 * Unit test class for the SourceObject model.
 */
public class SourceObjectTest {
  ...
  public void testSourceObject() throws Throwable {
    ...
    SourceObject sourceObjectModelNew = TestUtilities.deserialize(json, SourceObject.class);
    assertTrue(sourceObjectModelNew instanceof SourceObject);
  }
}