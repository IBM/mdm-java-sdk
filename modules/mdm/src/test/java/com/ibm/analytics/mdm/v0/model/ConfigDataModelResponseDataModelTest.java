...
/**
 * Unit test class for the ConfigDataModelResponseDataModel model.
 */
public class ConfigDataModelResponseDataModelTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigDataModelResponseDataModel() throws Throwable {
    ConfigDataModelResponseDataModel configDataModelResponseDataModelModel = new ConfigDataModelResponseDataModel();
    assertNull(configDataModelResponseDataModelModel.getRecordTypes());
    assertNull(configDataModelResponseDataModelModel.getAttributeTypes());
    assertNull(configDataModelResponseDataModelModel.getRelationshipTypes());
    assertNull(configDataModelResponseDataModelModel.getLocale());
    assertNull(configDataModelResponseDataModelModel.getSystemProperties());
  }
}