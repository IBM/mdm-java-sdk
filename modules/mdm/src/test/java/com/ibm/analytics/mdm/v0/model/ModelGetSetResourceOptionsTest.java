...
/**
 * Unit test class for the ModelGetSetResourceOptions model.
 */
public class ModelGetSetResourceOptionsTest {
  ...
  public void testModelGetSetResourceOptionsError() throws Throwable {
    new ModelGetSetResourceOptions.Builder().build();
  }
