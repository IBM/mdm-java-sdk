...
/**
 * Unit test class for the ModelPatchFlowOptions model.
 */
public class ModelPatchFlowOptionsTest {
  ...
  public void testModelPatchFlowOptionsError() throws Throwable {
    new ModelPatchFlowOptions.Builder().build();
  }
