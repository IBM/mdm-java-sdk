...
/**
 * Unit test class for the ModelGetMapResourceOptions model.
 */
public class ModelGetMapResourceOptionsTest {
  ...
  public void testModelGetMapResourceOptionsError() throws Throwable {
    new ModelGetMapResourceOptions.Builder().build();
  }
