...
/**
 * Unit test class for the RetrieveRulesOptions model.
 */
public class RetrieveRulesOptionsTest {
  ...
  public void testRetrieveRulesOptionsError() throws Throwable {
    new RetrieveRulesOptions.Builder().build();
  }
