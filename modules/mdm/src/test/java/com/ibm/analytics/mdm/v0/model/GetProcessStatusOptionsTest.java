...
/**
 * Unit test class for the GetProcessStatusOptions model.
 */
public class GetProcessStatusOptionsTest {
  ...
  public void testGetProcessStatusOptionsError() throws Throwable {
    new GetProcessStatusOptions.Builder().build();
  }
