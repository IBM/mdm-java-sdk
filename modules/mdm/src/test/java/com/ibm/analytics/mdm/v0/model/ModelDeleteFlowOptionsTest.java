...
/**
 * Unit test class for the ModelDeleteFlowOptions model.
 */
public class ModelDeleteFlowOptionsTest {
  ...
  public void testModelDeleteFlowOptionsError() throws Throwable {
    new ModelDeleteFlowOptions.Builder().build();
  }
