 ...
 */
public class PostDeriveResponse extends GenericModel {

  @SerializedName("index_response")
  protected List<PostDeriveResponseIndexResponse> indexResponse;
   ...
   */
  public List<PostDeriveResponseIndexResponse> getIndexResponse() {
