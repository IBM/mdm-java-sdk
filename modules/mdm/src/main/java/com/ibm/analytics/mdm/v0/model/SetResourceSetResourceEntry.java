 ...
 */
public class SetResourceSetResourceEntry extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(SetResourceSetResourceEntry setResourceSetResourceEntry) {
      this.dataType = setResourceSetResourceEntry.dataType;
      this.regex = setResourceSetResourceEntry.regex;
      this.values = setResourceSetResourceEntry.values;
      this.category = setResourceSetResourceEntry.category;
    }
    ...
    /**
     * Builds a SetResourceSetResourceEntry.
     *
     * @return the new SetResourceSetResourceEntry instance
     */
    public SetResourceSetResourceEntry build() {
      return new SetResourceSetResourceEntry(this);
    }
     ...
     * @return the SetResourceSetResourceEntry builder
     */
  ...
  protected SetResourceSetResourceEntry(Builder builder) {
   ...
   * New builder.
   *
   * @return a SetResourceSetResourceEntry builder
   */
