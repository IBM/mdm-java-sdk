...
/**
 * The dataGetRecord options.
 */
public class DataGetRecordOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(DataGetRecordOptions dataGetRecordOptions) {
      this.id = dataGetRecordOptions.id;
      this.include = dataGetRecordOptions.include;
      this.exclude = dataGetRecordOptions.exclude;
    }
    ...
    /**
     * Builds a DataGetRecordOptions.
     *
     * @return the new DataGetRecordOptions instance
     */
    public DataGetRecordOptions build() {
      return new DataGetRecordOptions(this);
    }
     ...
     * @return the DataGetRecordOptions builder
     */
  ...
  protected DataGetRecordOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a DataGetRecordOptions builder
   */
