 ...
 */
public class PutIndexResponse extends GenericModel {

  @SerializedName("impacted_records")
  protected Map<String, List<PutIndexResponseRecordinfo>> impactedRecords;
   ...
   */
  public Map<String, List<PutIndexResponseRecordinfo>> getImpactedRecords() {
