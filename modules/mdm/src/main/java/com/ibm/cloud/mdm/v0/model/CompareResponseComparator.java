 ...
 * A single comparator.
 */
public class CompareResponseComparator extends GenericModel {

  protected Float score;
  protected List<CompareResponseCompareMethod> methods;
   ...
   * @return the methods
   */
  public List<CompareResponseCompareMethod> getMethods() {
    return methods;
  }
