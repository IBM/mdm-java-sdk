...
public class GetMatchingRecordRulesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetMatchingRecordRulesOptions instance.
     *
     * @param getMatchingRecordRulesOptions the instance to initialize the Builder with
     */
