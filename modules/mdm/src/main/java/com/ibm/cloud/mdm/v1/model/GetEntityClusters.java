 ...
 */
public class GetEntityClusters extends GenericModel {
  ...
  protected List<GetEntityClustersCluster> results;
  protected Map<String, Object> first;

  protected GetEntityClusters() { }
   ...
   * @return the results
   */
  public List<GetEntityClustersCluster> getResults() {
    return results;
  }
