...
public class AddConfiguratorConfigurationAssetOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing AddConfiguratorConfigurationAssetOptions instance.
     *
     * @param addConfiguratorConfigurationAssetOptions the instance to initialize the Builder with
     */
  ...
  protected AddConfiguratorConfigurationAssetOptions() { }
