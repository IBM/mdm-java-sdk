...
public class ResiliencyRulesManualLink extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ResiliencyRulesManualLink instance.
     *
     * @param resiliencyRulesManualLink the instance to initialize the Builder with
     */
