...
public class ReplaceDataRecordOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ReplaceDataRecordOptions instance.
     *
     * @param replaceDataRecordOptions the instance to initialize the Builder with
     */
