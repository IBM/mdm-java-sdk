...
public class GetConfiguratorPairAnalysisOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetConfiguratorPairAnalysisOptions instance.
     *
     * @param getConfiguratorPairAnalysisOptions the instance to initialize the Builder with
     */
