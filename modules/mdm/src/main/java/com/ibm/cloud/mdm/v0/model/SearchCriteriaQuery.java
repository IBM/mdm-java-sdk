 ...
 */
public class SearchCriteriaQuery extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(SearchCriteriaQuery searchCriteriaQuery) {
      this.expressions = searchCriteriaQuery.expressions;
      this.operation = searchCriteriaQuery.operation;
    }
    ...
    /**
     * Builds a SearchCriteriaQuery.
     *
     * @return the new SearchCriteriaQuery instance
     */
    public SearchCriteriaQuery build() {
      return new SearchCriteriaQuery(this);
    }
     ...
     * @return the SearchCriteriaQuery builder
     */
  ...
  protected SearchCriteriaQuery(Builder builder) {
   ...
   * New builder.
   *
   * @return a SearchCriteriaQuery builder
   */
