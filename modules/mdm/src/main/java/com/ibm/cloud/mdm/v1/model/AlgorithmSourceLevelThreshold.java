 ...
 */
public class AlgorithmSourceLevelThreshold extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing AlgorithmSourceLevelThreshold instance.
     *
     * @param algorithmSourceLevelThreshold the instance to initialize the Builder with
     */
    private Builder(AlgorithmSourceLevelThreshold algorithmSourceLevelThreshold) {
      this.srcxsrc = algorithmSourceLevelThreshold.srcxsrc;
      this.xDefault = algorithmSourceLevelThreshold.xDefault;
    }
    ...
    /**
     * Builds a AlgorithmSourceLevelThreshold.
     *
     * @return the new AlgorithmSourceLevelThreshold instance
     */
    public AlgorithmSourceLevelThreshold build() {
      return new AlgorithmSourceLevelThreshold(this);
    }
     ...
     * @return the AlgorithmSourceLevelThreshold builder
     */
  ...
  protected AlgorithmSourceLevelThreshold() { }

  protected AlgorithmSourceLevelThreshold(Builder builder) {
   ...
   * New builder.
   *
   * @return a AlgorithmSourceLevelThreshold builder
   */
