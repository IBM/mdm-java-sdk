...
public class ReplaceModelSetResourceOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ReplaceModelSetResourceOptions instance.
     *
     * @param replaceModelSetResourceOptions the instance to initialize the Builder with
     */
  ...
  protected ReplaceModelSetResourceOptions() { }
