...
public class DataLoadSourceCredentials extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DataLoadSourceCredentials instance.
     *
     * @param dataLoadSourceCredentials the instance to initialize the Builder with
     */
  ...
  protected DataLoadSourceCredentials() { }
