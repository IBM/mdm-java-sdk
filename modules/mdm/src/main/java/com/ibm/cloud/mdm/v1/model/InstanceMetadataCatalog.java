...
public class InstanceMetadataCatalog extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing InstanceMetadataCatalog instance.
     *
     * @param instanceMetadataCatalog the instance to initialize the Builder with
     */
  ...
  protected InstanceMetadataCatalog() { }
