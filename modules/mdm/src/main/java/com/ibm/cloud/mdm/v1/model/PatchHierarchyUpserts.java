 ...
 */
public class PatchHierarchyUpserts extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing PatchHierarchyUpserts instance.
     *
     * @param patchHierarchyUpserts the instance to initialize the Builder with
     */
    private Builder(PatchHierarchyUpserts patchHierarchyUpserts) {
      this.type = patchHierarchyUpserts.type;
      this.attributes = patchHierarchyUpserts.attributes;
      this.systemAttributes = patchHierarchyUpserts.systemAttributes;
      this.typeName = patchHierarchyUpserts.typeName;
      this.referenceId = patchHierarchyUpserts.referenceId;
      this.nodes = patchHierarchyUpserts.nodes;
      this.relationships = patchHierarchyUpserts.relationships;
      this.associatedObjects = patchHierarchyUpserts.associatedObjects;
    }
    ...
    /**
     * Builds a PatchHierarchyUpserts.
     *
     * @return the new PatchHierarchyUpserts instance
     */
    public PatchHierarchyUpserts build() {
      return new PatchHierarchyUpserts(this);
    }
     ...
     * @return the PatchHierarchyUpserts builder
     */
  ...
  protected PatchHierarchyUpserts() { }

  protected PatchHierarchyUpserts(Builder builder) {
   ...
   * New builder.
   *
   * @return a PatchHierarchyUpserts builder
   */
