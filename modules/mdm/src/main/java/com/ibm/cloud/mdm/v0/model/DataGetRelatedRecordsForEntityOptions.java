...
/**
 * The dataGetRelatedRecordsForEntity options.
 */
public class DataGetRelatedRecordsForEntityOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(DataGetRelatedRecordsForEntityOptions dataGetRelatedRecordsForEntityOptions) {
      this.id = dataGetRelatedRecordsForEntityOptions.id;
      this.recordType = dataGetRelatedRecordsForEntityOptions.recordType;
      this.relationshipType = dataGetRelatedRecordsForEntityOptions.relationshipType;
      this.limit = dataGetRelatedRecordsForEntityOptions.limit;
      this.offset = dataGetRelatedRecordsForEntityOptions.offset;
      this.include = dataGetRelatedRecordsForEntityOptions.include;
      this.exclude = dataGetRelatedRecordsForEntityOptions.exclude;
    }
    ...
    /**
     * Builds a DataGetRelatedRecordsForEntityOptions.
     *
     * @return the new DataGetRelatedRecordsForEntityOptions instance
     */
    public DataGetRelatedRecordsForEntityOptions build() {
      return new DataGetRelatedRecordsForEntityOptions(this);
    }
     ...
     * @return the DataGetRelatedRecordsForEntityOptions builder
     */
  ...
  protected DataGetRelatedRecordsForEntityOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a DataGetRelatedRecordsForEntityOptions builder
   */
