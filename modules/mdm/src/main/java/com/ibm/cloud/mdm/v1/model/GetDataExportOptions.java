...
public class GetDataExportOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetDataExportOptions instance.
     *
     * @param getDataExportOptions the instance to initialize the Builder with
     */
  ...
  protected GetDataExportOptions() { }
