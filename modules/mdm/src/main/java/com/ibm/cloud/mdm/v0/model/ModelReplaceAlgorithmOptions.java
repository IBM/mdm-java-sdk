...
/**
 * The modelReplaceAlgorithm options.
 */
public class ModelReplaceAlgorithmOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ModelReplaceAlgorithmOptions modelReplaceAlgorithmOptions) {
      ...
      this.entityTypes = modelReplaceAlgorithmOptions.entityTypes;
      this.locale = modelReplaceAlgorithmOptions.locale;
    }
     ...
     *
     * @return the new ModelReplaceAlgorithmOptions instance
     */
   ...
   * New builder.
   *
   * @return a ModelReplaceAlgorithmOptions builder
   */
