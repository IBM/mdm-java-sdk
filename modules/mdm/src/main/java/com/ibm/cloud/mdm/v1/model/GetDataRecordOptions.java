...
public class GetDataRecordOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetDataRecordOptions instance.
     *
     * @param getDataRecordOptions the instance to initialize the Builder with
     */
  ...
  protected GetDataRecordOptions() { }
