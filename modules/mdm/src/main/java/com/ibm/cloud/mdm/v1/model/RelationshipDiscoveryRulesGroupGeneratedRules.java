...
public class RelationshipDiscoveryRulesGroupGeneratedRules extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RelationshipDiscoveryRulesGroupGeneratedRules instance.
     *
     * @param relationshipDiscoveryRulesGroupGeneratedRules the instance to initialize the Builder with
     */
