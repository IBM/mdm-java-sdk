...
public class GetModelWorkflowsConfigurationOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetModelWorkflowsConfigurationOptions instance.
     *
     * @param getModelWorkflowsConfigurationOptions the instance to initialize the Builder with
     */
