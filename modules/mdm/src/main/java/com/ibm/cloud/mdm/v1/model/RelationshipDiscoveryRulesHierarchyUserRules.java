...
public class RelationshipDiscoveryRulesHierarchyUserRules extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RelationshipDiscoveryRulesHierarchyUserRules instance.
     *
     * @param relationshipDiscoveryRulesHierarchyUserRules the instance to initialize the Builder with
     */
