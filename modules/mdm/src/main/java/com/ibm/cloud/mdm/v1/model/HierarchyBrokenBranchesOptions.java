...
public class HierarchyBrokenBranchesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing HierarchyBrokenBranchesOptions instance.
     *
     * @param hierarchyBrokenBranchesOptions the instance to initialize the Builder with
     */
