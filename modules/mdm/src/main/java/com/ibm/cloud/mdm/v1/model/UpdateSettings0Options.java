...
/**
 * The updateSettings0 options.
 */
public class UpdateSettings0Options extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdateSettings0Options updateSettings0Options) {
      ...
      this.recordTypes = updateSettings0Options.recordTypes;
      this.groupTypes = updateSettings0Options.groupTypes;
      this.entityTypes = updateSettings0Options.entityTypes;
      this.attributeTypes = updateSettings0Options.attributeTypes;
      this.hierarchyTypes = updateSettings0Options.hierarchyTypes;
      this.workspace = updateSettings0Options.workspace;
      this.settingsId = updateSettings0Options.settingsId;
    }
    ...
    /**
     * Builds a UpdateSettings0Options.
     *
     * @return the new UpdateSettings0Options instance
     */
    public UpdateSettings0Options build() {
      return new UpdateSettings0Options(this);
    }
     ...
     *
     * @param id the id
     * @return the UpdateSettings0Options builder
     */
  ...
  protected UpdateSettings0Options() { }

  protected UpdateSettings0Options(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateSettings0Options builder
   */
