...
public class GetHierarchyStatisticsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetHierarchyStatisticsOptions instance.
     *
     * @param getHierarchyStatisticsOptions the instance to initialize the Builder with
     */
