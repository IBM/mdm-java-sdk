...
public class NodeWithAttributesDataRecord extends NodeWithAttributes {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing NodeWithAttributesDataRecord instance.
     *
     * @param nodeWithAttributesDataRecord the instance to initialize the Builder with
     */
