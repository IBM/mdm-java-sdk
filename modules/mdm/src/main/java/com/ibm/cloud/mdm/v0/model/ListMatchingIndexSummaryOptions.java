...
public class ListMatchingIndexSummaryOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListMatchingIndexSummaryOptions listMatchingIndexSummaryOptions) {
      ...
      this.maxResult = listMatchingIndexSummaryOptions.maxResult;
    }
   ...
   * Gets the maxResult.
   *
   * The maximum expected number of entries in largest_entities_list within response. The default limit is 10.
   *
