...
public class RelationshipDiscoveryRulesRulesBuilderWrapper extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RelationshipDiscoveryRulesRulesBuilderWrapper instance.
     *
     * @param relationshipDiscoveryRulesRulesBuilderWrapper the instance to initialize the Builder with
     */
