...
public class ListMatchingClusterRecordsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListMatchingClusterRecordsOptions instance.
     *
     * @param listMatchingClusterRecordsOptions the instance to initialize the Builder with
     */
