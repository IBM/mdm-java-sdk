...
public class DataModelEntityTypeSystemProperties extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DataModelEntityTypeSystemProperties instance.
     *
     * @param dataModelEntityTypeSystemProperties the instance to initialize the Builder with
     */
