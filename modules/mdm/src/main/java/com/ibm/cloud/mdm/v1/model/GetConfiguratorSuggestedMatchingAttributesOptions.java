...
public class GetConfiguratorSuggestedMatchingAttributesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetConfiguratorSuggestedMatchingAttributesOptions instance.
     *
     * @param getConfiguratorSuggestedMatchingAttributesOptions the instance to initialize the Builder with
     */
