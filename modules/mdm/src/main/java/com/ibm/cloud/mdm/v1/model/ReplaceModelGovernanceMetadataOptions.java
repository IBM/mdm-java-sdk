...
public class ReplaceModelGovernanceMetadataOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ReplaceModelGovernanceMetadataOptions instance.
     *
     * @param replaceModelGovernanceMetadataOptions the instance to initialize the Builder with
     */
