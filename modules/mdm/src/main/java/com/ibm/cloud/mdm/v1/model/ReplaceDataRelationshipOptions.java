...
public class ReplaceDataRelationshipOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ReplaceDataRelationshipOptions instance.
     *
     * @param replaceDataRelationshipOptions the instance to initialize the Builder with
     */
