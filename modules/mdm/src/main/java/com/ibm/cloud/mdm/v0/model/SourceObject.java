 ...
 * source rules.
 */
public class SourceObject extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(SourceObject sourceObject) {
      this.entityTypes = sourceObject.entityTypes;
      this.recordTypes = sourceObject.recordTypes;
    }
    ...
    /**
     * Builds a SourceObject.
     *
     * @return the new SourceObject instance
     */
     ...
     * @return the SourceObject builder
     */
  ...
  protected SourceObject(Builder builder) {
