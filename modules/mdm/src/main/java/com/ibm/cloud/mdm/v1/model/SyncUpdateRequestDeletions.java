...
public class SyncUpdateRequestDeletions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing SyncUpdateRequestDeletions instance.
     *
     * @param syncUpdateRequestDeletions the instance to initialize the Builder with
     */
