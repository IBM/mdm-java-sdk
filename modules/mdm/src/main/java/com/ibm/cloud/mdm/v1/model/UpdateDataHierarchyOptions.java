...
public class UpdateDataHierarchyOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateDataHierarchyOptions instance.
     *
     * @param updateDataHierarchyOptions the instance to initialize the Builder with
     */
