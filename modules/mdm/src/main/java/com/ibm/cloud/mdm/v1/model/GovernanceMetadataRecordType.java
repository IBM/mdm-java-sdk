...
public class GovernanceMetadataRecordType extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GovernanceMetadataRecordType instance.
     *
     * @param governanceMetadataRecordType the instance to initialize the Builder with
     */
