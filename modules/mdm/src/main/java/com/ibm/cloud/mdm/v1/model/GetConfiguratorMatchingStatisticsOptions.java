...
public class GetConfiguratorMatchingStatisticsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetConfiguratorMatchingStatisticsOptions instance.
     *
     * @param getConfiguratorMatchingStatisticsOptions the instance to initialize the Builder with
     */
  ...
  protected GetConfiguratorMatchingStatisticsOptions() { }
