...
public class Mdm extends BaseService {
 ...
 /**
  ...
  public ServiceCall<ProcessStatus> createConfiguratorProcess(CreateConfiguratorProcessOptions createConfiguratorProcessOptions) {
    ...
    RequestBuilder builder = RequestBuilder.post(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/mdm/configuration/v0/configuration_metadata/processes"));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("mdm", "v0", "createConfiguratorProcess");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
   ...
   */
  public ServiceCall<BucketCredentialsResponse> createDataBucketCredentials(CreateDataBucketCredentialsOptions createDataBucketCredentialsOptions) {
   ...
   * @return a {@link ServiceCall} with a result of type {@link BucketCredentialsResponse}
   */
  public ServiceCall<BucketCredentialsResponse> createDataBucketCredentials() {
   ...
   */
  public ServiceCall<Flow> listModelActiveFlow(ListModelActiveFlowOptions listModelActiveFlowOptions) {
   ...
   * @return a {@link ServiceCall} with a result of type {@link Flow}
   */
  public ServiceCall<Flow> listModelActiveFlow() {
