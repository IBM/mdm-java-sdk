...
/**
 * The listMatchingEntityIssues options.
 */
public class ListMatchingEntityIssuesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListMatchingEntityIssuesOptions listMatchingEntityIssuesOptions) {
      ...
      this.limit = listMatchingEntityIssuesOptions.limit;
      this.offset = listMatchingEntityIssuesOptions.offset;
      this.fetchTotalCount = listMatchingEntityIssuesOptions.fetchTotalCount;
    }
    ...
    /**
     * Builds a ListMatchingEntityIssuesOptions.
     *
     * @return the new ListMatchingEntityIssuesOptions instance
     */
    public ListMatchingEntityIssuesOptions build() {
      return new ListMatchingEntityIssuesOptions(this);
    }
  ...
  protected ListMatchingEntityIssuesOptions() { }

  protected ListMatchingEntityIssuesOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListMatchingEntityIssuesOptions builder
   */
   ...
   *
   * If true, the total number of issues for the given entity ids and types will be returned. Otherwise, the number of
   * results will be returned. Default value is true.
   *
