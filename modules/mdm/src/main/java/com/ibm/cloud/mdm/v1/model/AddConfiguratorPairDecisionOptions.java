...
public class AddConfiguratorPairDecisionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing AddConfiguratorPairDecisionOptions instance.
     *
     * @param addConfiguratorPairDecisionOptions the instance to initialize the Builder with
     */
    private Builder(AddConfiguratorPairDecisionOptions addConfiguratorPairDecisionOptions) {
      ...
      this.category = addConfiguratorPairDecisionOptions.category;
      this.recordType = addConfiguratorPairDecisionOptions.recordType;
      this.entityType = addConfiguratorPairDecisionOptions.entityType;
    }
  ...
  protected AddConfiguratorPairDecisionOptions() { }
