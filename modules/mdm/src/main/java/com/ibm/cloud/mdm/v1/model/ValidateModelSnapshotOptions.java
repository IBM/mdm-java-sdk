...
public class ValidateModelSnapshotOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ValidateModelSnapshotOptions instance.
     *
     * @param validateModelSnapshotOptions the instance to initialize the Builder with
     */
