...
public class ListConfiguratorProcessesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListConfiguratorProcessesOptions instance.
     *
     * @param listConfiguratorProcessesOptions the instance to initialize the Builder with
     */
  ...
  protected ListConfiguratorProcessesOptions() { }
