...
public class DeleteModelEventSubscriptionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteModelEventSubscriptionOptions instance.
     *
     * @param deleteModelEventSubscriptionOptions the instance to initialize the Builder with
     */
