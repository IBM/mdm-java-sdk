...
public class GetModelMapResourceOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetModelMapResourceOptions instance.
     *
     * @param getModelMapResourceOptions the instance to initialize the Builder with
     */
  ...
  protected GetModelMapResourceOptions() { }
