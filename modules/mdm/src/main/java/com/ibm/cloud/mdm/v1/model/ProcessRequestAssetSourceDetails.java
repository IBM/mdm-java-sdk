...
public class ProcessRequestAssetSourceDetails extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ProcessRequestAssetSourceDetails instance.
     *
     * @param processRequestAssetSourceDetails the instance to initialize the Builder with
     */
  ...
  protected ProcessRequestAssetSourceDetails() { }
