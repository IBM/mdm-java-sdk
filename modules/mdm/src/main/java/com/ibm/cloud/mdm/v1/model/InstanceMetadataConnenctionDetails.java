...
public class InstanceMetadataConnenctionDetails extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing InstanceMetadataConnenctionDetails instance.
     *
     * @param instanceMetadataConnenctionDetails the instance to initialize the Builder with
     */
