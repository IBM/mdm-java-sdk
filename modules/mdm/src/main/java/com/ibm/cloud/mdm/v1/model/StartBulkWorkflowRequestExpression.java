...
public class StartBulkWorkflowRequestExpression extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing StartBulkWorkflowRequestExpression instance.
     *
     * @param startBulkWorkflowRequestExpression the instance to initialize the Builder with
     */
