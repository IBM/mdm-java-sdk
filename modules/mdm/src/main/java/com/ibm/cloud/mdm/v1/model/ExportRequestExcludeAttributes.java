 ...
 */
public class ExportRequestExcludeAttributes extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ExportRequestExcludeAttributes exportRequestExcludeAttributes) {
      ...
      this.entityAttributes = exportRequestExcludeAttributes.entityAttributes;
    }
    ...
    /**
     * Builds a ExportRequestExcludeAttributes.
     *
     * @return the new ExportRequestExcludeAttributes instance
     */
    public ExportRequestExcludeAttributes build() {
      return new ExportRequestExcludeAttributes(this);
    }
  ...
  protected ExportRequestExcludeAttributes() { }

  protected ExportRequestExcludeAttributes(Builder builder) {
   ...
   * New builder.
   *
   * @return a ExportRequestExcludeAttributes builder
   */
