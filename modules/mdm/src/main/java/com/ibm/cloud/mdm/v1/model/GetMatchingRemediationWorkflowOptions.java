...
public class GetMatchingRemediationWorkflowOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetMatchingRemediationWorkflowOptions instance.
     *
     * @param getMatchingRemediationWorkflowOptions the instance to initialize the Builder with
     */
