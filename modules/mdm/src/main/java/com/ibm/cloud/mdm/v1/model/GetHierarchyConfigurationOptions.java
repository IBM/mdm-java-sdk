...
public class GetHierarchyConfigurationOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetHierarchyConfigurationOptions instance.
     *
     * @param getHierarchyConfigurationOptions the instance to initialize the Builder with
     */
