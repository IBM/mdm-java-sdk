...
public class RelationshipDiscoveryRulesGroupUserRules extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing RelationshipDiscoveryRulesGroupUserRules instance.
     *
     * @param relationshipDiscoveryRulesGroupUserRules the instance to initialize the Builder with
     */
