...
public class ReplaceModelDataModelOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ReplaceModelDataModelOptions instance.
     *
     * @param replaceModelDataModelOptions the instance to initialize the Builder with
     */
