...
/**
 * The modelReplaceMapResource options.
 */
public class ModelReplaceMapResourceOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a ModelReplaceMapResourceOptions.
     *
     * @return the new ModelReplaceMapResourceOptions instance
     */
   ...
   * New builder.
   *
   * @return a ModelReplaceMapResourceOptions builder
   */
