...
/**
 * The putGroup options.
 */
public class PutGroupOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing PutGroupOptions instance.
     *
     * @param putGroupOptions the instance to initialize the Builder with
     */
    private Builder(PutGroupOptions putGroupOptions) {
      this.id = putGroupOptions.id;
      this.type = putGroupOptions.type;
      this.attributes = putGroupOptions.attributes;
      this.typeName = putGroupOptions.typeName;
      this.systemAttributes = putGroupOptions.systemAttributes;
      this.groupAssociations = putGroupOptions.groupAssociations;
      this.groupNumber = putGroupOptions.groupNumber;
      this.memberCount = putGroupOptions.memberCount;
    }
    ...
    /**
     * Builds a PutGroupOptions.
     *
     * @return the new PutGroupOptions instance
     */
    public PutGroupOptions build() {
      return new PutGroupOptions(this);
    }
     ...
     * @return the PutGroupOptions builder
     */
  ...
  protected PutGroupOptions() { }

  protected PutGroupOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a PutGroupOptions builder
   */
