...
public class ListDataExportsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListDataExportsOptions instance.
     *
     * @param listDataExportsOptions the instance to initialize the Builder with
     */
  ...
  protected ListDataExportsOptions() { }
