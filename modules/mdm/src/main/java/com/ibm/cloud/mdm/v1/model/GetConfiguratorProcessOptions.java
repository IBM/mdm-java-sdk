...
public class GetConfiguratorProcessOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetConfiguratorProcessOptions instance.
     *
     * @param getConfiguratorProcessOptions the instance to initialize the Builder with
     */
