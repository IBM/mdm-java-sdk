...
public class GetModelDataModelOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetModelDataModelOptions instance.
     *
     * @param getModelDataModelOptions the instance to initialize the Builder with
     */
