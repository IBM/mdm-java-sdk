...
public class CreateMatchingMatchJobOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing CreateMatchingMatchJobOptions instance.
     *
     * @param createMatchingMatchJobOptions the instance to initialize the Builder with
     */
