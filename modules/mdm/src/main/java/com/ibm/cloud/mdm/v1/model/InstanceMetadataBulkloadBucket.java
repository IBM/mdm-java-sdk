...
public class InstanceMetadataBulkloadBucket extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing InstanceMetadataBulkloadBucket instance.
     *
     * @param instanceMetadataBulkloadBucket the instance to initialize the Builder with
     */
