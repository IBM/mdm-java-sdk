...
public class GetModelFlowOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetModelFlowOptions instance.
     *
     * @param getModelFlowOptions the instance to initialize the Builder with
     */
