...
public class GetModelAlgorithmOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetModelAlgorithmOptions instance.
     *
     * @param getModelAlgorithmOptions the instance to initialize the Builder with
     */
  ...
  protected GetModelAlgorithmOptions() { }
