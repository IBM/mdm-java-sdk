...
public class GetMatchingRecordsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetMatchingRecordsOptions instance.
     *
     * @param getMatchingRecordsOptions the instance to initialize the Builder with
     */
