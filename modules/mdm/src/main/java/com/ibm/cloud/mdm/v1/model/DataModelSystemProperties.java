...
public class DataModelSystemProperties extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DataModelSystemProperties instance.
     *
     * @param dataModelSystemProperties the instance to initialize the Builder with
     */
