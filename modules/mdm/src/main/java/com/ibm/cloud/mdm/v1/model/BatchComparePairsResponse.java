 ...
 */
public class BatchComparePairsResponse extends GenericModel {

  @SerializedName("comparison_details")
  protected List<Compare> comparisonDetails;

  protected BatchComparePairsResponse() { }
   ...
   */
  public List<Compare> getComparisonDetails() {
