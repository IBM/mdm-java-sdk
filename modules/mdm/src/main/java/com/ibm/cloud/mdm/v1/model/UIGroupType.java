 ...
 */
public class UIGroupType extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UIGroupType instance.
     *
     * @param uiGroupType the instance to initialize the Builder with
     */
    private Builder(UIGroupType uiGroupType) {
      this.label = uiGroupType.label;
      this.searchResultAttributes = uiGroupType.searchResultAttributes;
      this.summary = uiGroupType.summary;
      this.attributeGroups = uiGroupType.attributeGroups;
      this.cards = uiGroupType.cards;
    }
    ...
    /**
     * Builds a UIGroupType.
     *
     * @return the new UIGroupType instance
     */
    public UIGroupType build() {
      return new UIGroupType(this);
    }
     ...
     * @return the UIGroupType builder
     */
  ...
  protected UIGroupType() { }

  protected UIGroupType(Builder builder) {
    label = builder.label;
