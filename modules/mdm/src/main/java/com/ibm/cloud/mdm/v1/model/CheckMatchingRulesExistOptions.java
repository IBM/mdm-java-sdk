...
public class CheckMatchingRulesExistOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing CheckMatchingRulesExistOptions instance.
     *
     * @param checkMatchingRulesExistOptions the instance to initialize the Builder with
     */
