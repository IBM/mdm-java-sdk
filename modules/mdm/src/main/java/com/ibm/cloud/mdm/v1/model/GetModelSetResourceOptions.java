...
public class GetModelSetResourceOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetModelSetResourceOptions instance.
     *
     * @param getModelSetResourceOptions the instance to initialize the Builder with
     */
  ...
  protected GetModelSetResourceOptions() { }
