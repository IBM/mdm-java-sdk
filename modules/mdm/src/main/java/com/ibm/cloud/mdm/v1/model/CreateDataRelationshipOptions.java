...
public class CreateDataRelationshipOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing CreateDataRelationshipOptions instance.
     *
     * @param createDataRelationshipOptions the instance to initialize the Builder with
     */
